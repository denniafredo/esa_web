                    ...
                    <ul class="navbar-nav ml-auto navbar-list align-items-center">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="avatar">
                                                            ...
                                                            <span><img class="avatar is-squared rounded-circle"
                                                                       src="{{asset('images/user/2.jpg')}}" alt="2.jpg"></span>
                                                            </div>
                                                        </div>
                                                        <div class="list-style-detail ml-2 mr-2">
                            ...
                            <li class="nav-item nav-icon dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                    <form method="POST" action="{{ url('logout') }}">
                                        @csrf
                                        <li onclick="event.preventDefault(); this.closest('form').submit();" class="dropdown-item  d-flex svg-icon border-top">
                        ...
                        @else
                            <li class="nav-item nav-icon">
                                <a href="{{url('login')}}" class="nav-item nav-icon dropdown-toggle pr-0 search-toggle">
                                    <span class="mb-0 ml-2 user-name">Login</span>
                                </a>
                            </li>
                        @endif
                    </ul>
